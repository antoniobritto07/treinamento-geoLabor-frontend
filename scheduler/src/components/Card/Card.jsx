...
export default function Card(props) {
  ...
  const deleteTask = async (taskId) => {
    try {
      ...
      console.log(error);
      addToast("Some error occurred while trying to delete a task.", {
        appearance: "error",
      });
    }
  };
  ...
  const markTaskAsDone = async (taskId, task) => {
    try {
      ...
      console.log(error);
      addToast("Some error occurred while trying to mark task as done.", {
        appearance: "error",
      });
    }
  };
  ...
  return (
    <div
      ...
      style={
        is_Done ? { backgroundColor: "green" } : { backgroundColor: "red" }
      }
    >
